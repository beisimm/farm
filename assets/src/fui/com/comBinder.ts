...
import UI_disasterBtn from "./UI_disasterBtn";
import UI_effBox from "./UI_effBox";
import UI_faguang from "./UI_faguang";
import UI_redPoint from "./UI_redPoint";
import UI_taskBtn from "./UI_taskBtn";
import UI_informBtn from "./UI_informBtn";
import UI_ShopSecView from "./UI_ShopSecView";
import UI_Component2 from "./UI_Component2";
import UI_FriendItem1 from "./UI_FriendItem1";
...
import UI_DepositView from "./UI_DepositView";
import UI_DepositItem from "./UI_DepositItem";
...
export default class comBinder {
	public static bindAll():void {
		...
		fgui.UIObjectFactory.setExtension(UI_disasterBtn.URL, UI_disasterBtn);
		fgui.UIObjectFactory.setExtension(UI_effBox.URL, UI_effBox);
		fgui.UIObjectFactory.setExtension(UI_faguang.URL, UI_faguang);
		fgui.UIObjectFactory.setExtension(UI_redPoint.URL, UI_redPoint);
		fgui.UIObjectFactory.setExtension(UI_taskBtn.URL, UI_taskBtn);
		fgui.UIObjectFactory.setExtension(UI_informBtn.URL, UI_informBtn);
		fgui.UIObjectFactory.setExtension(UI_ShopSecView.URL, UI_ShopSecView);
		fgui.UIObjectFactory.setExtension(UI_Component2.URL, UI_Component2);
		fgui.UIObjectFactory.setExtension(UI_FriendItem1.URL, UI_FriendItem1);
		...
		fgui.UIObjectFactory.setExtension(UI_DepositView.URL, UI_DepositView);
		fgui.UIObjectFactory.setExtension(UI_DepositItem.URL, UI_DepositItem);
		fgui.UIObjectFactory.setExtension(UI_carousel.URL, UI_carousel);
		fgui.UIObjectFactory.setExtension(UI_wk7.URL, UI_wk7);
		fgui.UIObjectFactory.setExtension(UI_wk8.URL, UI_wk8);
		...
		fgui.UIObjectFactory.setExtension(UI_touxiang.URL, UI_touxiang);
